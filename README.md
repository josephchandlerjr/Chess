...
This started out as a console chess game. Now it has a GUI using swing components. 
You'll see additional classes suchs as PGNFile which were used by the original console game but
